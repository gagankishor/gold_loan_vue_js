  ...
  <b-container fluid>
    <b-row>
      <b-col sm="3" class="mb-4 text-center">
        <dashboard-card :heading="galleries ? galleries.title : 150"  subheading="Member" icon="bag"
          variant="warning" />
        <!-- <p>{{ galleries }}</p> -->
      ...
      <b-col sm="3" class="mb-4 text-center">
        <dashboard-card :heading="galleries ? galleries.title : 12" subheading=" Loan" icon="bag"
          variant="success" />
      </b-col>

      <b-col sm="3" class="mb-4 text-center">
        <dashboard-card :heading="galleries ? galleries.title : 15" subheading="Pending" icon="bag"
          variant="info" />
      </b-col>

      <b-col sm="3" class="mb-4 text-center">
        <dashboard-card :heading="galleries ? galleries.title : 468239" subheading="Total_Amount" icon="bag"
          variant="danger" />
      </b-col>
    </b-row>
