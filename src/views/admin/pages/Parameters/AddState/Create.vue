<template>
  ...
  <b-container fluid>
    <div class="">
      <h4 class="mb-5">Add Gold Item</h4>
    </div>
    <div class="mt-4"></div>
    ...
    <b-row>
      <b-col cols="4">
        ...
        <b-card>
        <form method="post" @submit="addstate">
        <b-row class="my-1">
          <b-col sm="12">
            <label for="input-none1" >Gold Item  NAME:</label>
            ...
            <b-form-input
              ...
              :state="null"
              class="mb-3 mt-3"
              placeholder="ENTER Gold Item NAME"
              required
            >
            <b-form-group id="example-input-group-1" label="Gold Item Name" label-for="example-input-1">
              <b-form-input 
                id="example-input-1"
      ...
      <b-col cols="8 ">
        ...
        <div>
          <b-card header="Gold Item Listing">
